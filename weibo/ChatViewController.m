...
- (void)addToolBar
{
    ...
    bgView.frame = CGRectMake(0, kScreenHeight - 64 - kToolBarH, kScreenWidth, kToolBarH);
...
- (BOOL)textFieldShouldReturn:(UITextField *)textField
{
    ...
    NSString *jid = [NSString stringWithFormat:@"%@@xmpp.wxhl.com",self.friendModel.friendId];
    [[MyXMPPManager shareManager] sendMessage:textField.text toUser:jid];
...
- (void)keyboardWillChange:(NSNotification *)note
{
    ...
    CGFloat moveY = kScreenHeight - 64 - keyFrame.size.height;
...
- (void)keyboardWillHide:(NSNotification *)note
{
    ...
    _chatView.bottom = kScreenHeight - 64 -_toolBar.height;
    // 添加内填充让表示图的内容可以现实到下面
